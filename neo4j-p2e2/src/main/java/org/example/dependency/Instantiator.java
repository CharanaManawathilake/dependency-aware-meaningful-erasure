...
import org.example.dependency.Cell.HyperEdge;
...
public class Instantiator {
    ...
    final String IT_RELATION = "INSERTED_AT";
    ...
    public Instantiator(
            ...
            HashMap<String, String> nodeName2keyProp,
        ...
        driver = GraphDatabase.driver(
                neo4jProperties.uri,
                AuthTokens.basic(
                        neo4jProperties.username,
                        neo4jProperties.password
                )
        );

        sessionConfig = SessionConfig.builder()
                .withDatabase(neo4jProperties.database)
                .build();
    }
    ...
    public void deleteCells(HashSet<Cell> toDelete)
            throws Neo4jException {

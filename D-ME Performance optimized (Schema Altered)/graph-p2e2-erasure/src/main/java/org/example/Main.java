    ...
    private static void iterateProperties(Instantiator instantiator, Set<Property> properties) throws Exception {
        ...
        for (var prop : properties) {
            ...
            for (String key : keys) {
                ...
                // System.out.println("\n[P2E2] Targeting Root Deletion -> Node: " + prop.node +
                // " | Key: " + key + " | Property: " + prop.property);
                ...
                // System.out.println("[P2E2] Dependency Graph Identified " +
                // deletionSets[2].size() + " total properties to erase.");
                // for (Cell c : deletionSets[2]) {
                // System.out.println(" -> Erasing " + c.property.node + " (Key: " + c.key + ")
